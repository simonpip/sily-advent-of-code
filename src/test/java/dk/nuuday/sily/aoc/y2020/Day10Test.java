...
public class Day10Test {
    ...
    public void testGetAdapterJumpsMultipliedData() throws IOException {
        List<Integer> adapters = FileUtil.readLines("y2020/day10.txt", Integer::valueOf);
    ...
    public void testCountDistinctAdapterConfigurationsExample2() throws IOException {
        List<Integer> adapters = FileUtil.readLines("y2020/day10_large_example.txt", Integer::valueOf);
