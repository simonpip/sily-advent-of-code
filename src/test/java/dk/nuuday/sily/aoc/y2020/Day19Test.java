...
public class Day19Test {
    ...
    public void testCountValidElementsData() throws IOException {
        Day19.DataSet dataSet = FileUtil.readFile("y2020/day19.txt", Day19.DataSet::new);
    ...
    public void testCountValidElementsLargeExample() throws IOException {
        Day19.DataSet dataSet = FileUtil.readFile("y2020/day19_large_example.txt", Day19.DataSet::new);
    ...
    public void testCountValidElementsLargeExampleModified() throws IOException {
        Day19.DataSet dataSet = FileUtil.readFile("y2020/day19_large_example_modified.txt", Day19.DataSet::new);
    ...
    public void testCountValidElementsDataModified() throws IOException {
        Day19.DataSet dataSet = FileUtil.readFile("y2020/day19_modified.txt", Day19.DataSet::new);
